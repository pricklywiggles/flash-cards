...
const SlateCard: FComponent<{ isGlowing?: boolean }> = ({
  ...
  return (
    <div className="relative flex h-full w-full flex-col sm:h-auto sm:w-auto">
      ...
      <div className="isolate flex h-full w-full flex-col overflow-hidden rounded-t-[3rem] border border-gray-700 bg-gradient-to-t from-slate-800 via-slate-900 to-slate-950 shadow-xl sm:h-auto sm:max-w-md sm:rounded-2xl">
        {children}
      </div>
    </div>
  );
