...
export default function Register() {
  return (
    <AuthPageContainer>
      <div className="my-6 flex flex-col items-center gap-1 sm:my-12 sm:gap-2 sm:text-xl md:my-24 md:text-2xl lg:text-3xl xl:text-4xl">
        <div className="">
        ...
        <Image
          className="order-first mb-6 h-20 w-20 sm:order-last sm:my-6 sm:mb-0 sm:h-24 sm:w-24 md:my-8 md:h-28 md:w-28 lg:h-32 lg:w-32"
